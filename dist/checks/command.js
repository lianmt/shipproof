...
export async function runCommandCheck(check, root) {
    ...
    return createResult(check, startedAt, errors.length === 0 ? "PASSED" : "FAILED", errors.length === 0 ? "command passed" : errors.join("; "), evidence);
}
