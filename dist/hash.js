...
export async function hashFiles(cwd, patterns) {
...
export async function hashFilesAtGitRef(cwd, patterns, ref) {
...
export async function workspaceFingerprint(cwd) {
    ...
    const untrackedResult = await runGit(["ls-files", "--others", "--exclude-standard", "-z", "--", "."], cwd, true);
